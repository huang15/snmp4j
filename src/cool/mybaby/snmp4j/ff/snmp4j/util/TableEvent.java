...
public class TableEvent extends RetrievalEvent {
     ...
     * @param source     the source of the event.
     * @param userObject the user object or <code>null</code>.
     * @param index      the index OID of the row.
     * @param cols       an array of <code>VariableBinding</code> instances containing the
     ...
     *
     * @return the row's index OID or <code>null</code> if {@link #isError()} returns
     * <code>true</code>.
     */
    public OID getIndex() {
        return index;
     ...
     *
     * @return an array of <code>VariableBinding</code> instances containing the
     * elements of the row. The array may contain <code>null</code> elements
     * which indicates that the agent does not return an instance for that
     * column and row index. If an element is not <code>null</code>, then
     * the <code>OID</code> of the variable binding contains the full instance

...
import cool.mybaby.snmp4j.ff.snmp4j.smi.Null;
...
public class TreeUtils extends AbstractSnmpUtility {
     ...
     * @param rootOID the OID that specifies the root of the sub-tree to retrieve
     *                (not included).
     * @return a possibly empty List of <code>TreeEvent</code> instances where each
     ...
     * @param rootOID    the OID that specifies the root of the sub-tree to retrieve
     *                   (not included).
     * @param userObject an optional user object that will be transparently handed over to the
     *                   supplied <code>TreeListener</code>.
     * @param listener   the <code>TreeListener</code> that processes the {@link TreeEvent}s
     ...
     *
     * @param maxRepetitions the maximum repetitions used for GETBULK requests. For SNMPv1 this
     ...
     * returned by this instance.
     *
     * @return the maximum repetitions used for GETBULK requests. For SNMPv1 this
     * values has no effect (it is then implicitly one).
     */
    ...
    class TreeRequest implements ResponseListener {
        ...
        public void onResponse(ResponseEvent event) {
            ...
            if (respPDU == null) {
                ...
                VariableBinding[] vbs =
                        (VariableBinding[]) l.toArray(new VariableBinding[0]);
                if (finished) {

...
public class ThreadPool {
     ...
     *
     * @param name the name prefix for the threads in this pool.
     * @param size the number of threads in this pool. This number also specifies the
     ...
     *
     * @param task a <code>Runnable</code> to execute.
     */
     ...
     *
     * @param respawnThreads if <code>true</code> then threads will be respawn.
     */

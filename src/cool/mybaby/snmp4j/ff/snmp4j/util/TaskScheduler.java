...
public class TaskScheduler implements Runnable {
     ...
     *
     * @param task a <code>SchedulerTask</code>.
     */
     ...
     *
     * @param task the <code>SchedulerTask</code> to be removed from the scheduler
     * @return <code>true</code> if the task could be removed.
     */
        ...
        while (!stop) {
            ...
            synchronized (this) {
                for (int i = 0; i < tasks.size(); i++) {
                    SchedulerTask task = (SchedulerTask) tasks.get(i);
                    if (task.isDone()) {
     ...
     *
     * @param stop <code>true</code> to stop the scheduler.
     */
     ...
     *
     * @return <code>true</code> if the scheduler has been stopped or is being stopped.
     */

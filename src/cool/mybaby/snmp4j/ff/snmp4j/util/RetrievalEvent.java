...
public abstract class RetrievalEvent extends EventObject {
     ...
     * @param userObject the user object or <code>null</code>.
     * @param status     one of the status constants defined for this object.
     */
     ...
     * @param source     the source of the event.
     * @param userObject the user object or <code>null</code>.
     * @param report     a PDU of type {@link PDU#REPORT}.
     */
     ...
     * @param source           the source of the event.
     * @param userObject       the user object or <code>null</code>.
     * @param variableBindings an array of <code>VariableBinding</code> instances.
     */
     ...
     *
     * @return one of the status constants defined for this object.
     ...
     *
     * @return <code>true</code> if the operation failed with an error.
     */
     ...
     *
     * @return an object instance if an user object has been specified or
     ...
     *
     * @return an Exception instance if there has been an exception instance
     ...
     *
     * @return a <code>ScopedPDU</code> instance if there has been a report PDU
     ...
     *
     * @return an error message or an empty string if no error occurred.
     */
    ...
    public String toString() {
        return getClass().getName() + "[vbs=" + Arrays.asList(vbs) +

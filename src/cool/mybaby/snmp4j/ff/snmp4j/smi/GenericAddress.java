...
public class GenericAddress extends SMIAddress {
    ...
    public static final String ADDRESS_TYPES_PROPERTIES =
            "cool.mybaby.snmp4j.ff.snmp4j.addresses";
     ...
     *
     * @param address an address string with a leading type specifier as defined in the
     ...
     * @return a <code>Address</code> instance of the address classes specified
     ...
     * @throws IllegalArgumentException if the address type indicator supplied is not know.
     */
     ...
     *
     * @param address an address string known by the GenericAddress.
     * @return boolean

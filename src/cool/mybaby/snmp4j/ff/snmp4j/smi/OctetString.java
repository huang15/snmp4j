...
public class OctetString extends AbstractVariable
     ...
     *
     * @param rawValue an array of bytes.
     * @param offset   the position (zero based) of the first byte to be copied from
     ...
     *
     * @param other an <code>OctetString</code> instance.
     */
     ...
     *
     * @param octetString an <code>OctetString</code> to append to this octet string.
     */
     ...
     *
     * @param string a String instance.
     */
     ...
     * @throws ArrayIndexOutOfBoundsException if <code>index</code> &lt; 0 or &gt; {@link #length()}.
     */
     ...
     *
     * @param index an index value greater or equal 0 and less than {@link #length()}.
    ...
    public boolean equals(Object o) {
        if (o instanceof OctetString) {
            ...
            return Arrays.equals(value, (byte[]) o);
        }
        return false;
    }
     ...
     * @return <code>true</code> if the bytes of this octet string up to the length
     ...
     * radix.
     *
     * @param string the string representation of an octet string.
     * @param radix  the radix of the string represantion.
     * @return the OctetString instance.
     * @since 1.6
     */
     ...
     * @return a string representation of this ocetet string in the specified radix.
     * @since 1.6
     */
     ...
     *
     * @param mask a mask where the n-th bit corresponds to the n-th bit in the returned
     *             OctetString.
     * @return the masked OctetString.
     * @since 1.7
     */
     ...
     *
     * @param octetString the input string to tokenize.
     * @param delimOctets a set of delimiter octets.
     * @return a Collection of OctetString instances that contain the tokens.
     */
     ...
     *
     * @param value a byte array that is copied into the value of the created
     *              <code>OctetString</code> or <code>null</code>.
     * @return an OctetString or <code>null</code> if <code>value</code>
     * is <code>null</code>.
     * @since 1.7
     */

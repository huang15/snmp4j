...
public class TimeTicks extends UnsignedInteger32 {
     ...
     * Copy constructor.
     *
     * @param other a TimeTicks instance.
     * @since 1.7
     */
     ...
     *
     * @param pattern a <code>MessageFormat</code> pattern that takes up to five parameters
     ...
     *
     * @param millis sets the value as <code>setValue(millis/10)</code>.
     * @since 1.7
     */

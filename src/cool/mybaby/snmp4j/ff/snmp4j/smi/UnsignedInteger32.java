...
public class UnsignedInteger32 extends AbstractVariable
     ...
     *
     * @param value a <code>long</code> value which must not be greater 2^32-1 and not less
     *              zero.
     * @throws IllegalArgumentException if <code>value</code> &lt; 0 or &gt; 2^32-1.
     */
     ...
     *
     * @param signedIntValue a signed int value.
     * @since 1.7
     */
     ...
     *
     * @param signedByteValue a signed byte value.
     * @since 1.7
     */

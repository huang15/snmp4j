...
public class VariableBinding
     ...
     *
     * @param oid the OID for the new variable binding.
     */
     ...
     *
     * @param oid      the OID for the new variable binding (must not be <code>null</code>).
     * @param variable the value for the new variable binding (must not be <code>null</code>).
     */
     ...
     *
     * @param oid an OID (must not be <code>null</code>).
     */
     ...
     *
     * @param variable a <code>Variable</code> (must not be <code>null</code>).
     */
     ...
     *
     * @return a SMI syntax identifier (see {@link SMIConstants}).
     */
     ...
     *
     * @return a string of the form <code>&lt;OID&gt; = &lt;Variable&gt;</code>.
     */
    ...
    public Object clone() {
        return new VariableBinding((OID) oid.clone(), (Variable) variable.clone());
    }
}

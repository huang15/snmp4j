...
public class OID extends AbstractVariable implements AssignableFromString {
    ...
    /**
     * Constructs an <code>OID</code> from a dotted String.
     *
     ...
     *
     * @param rawOID an array of <code>int</code> values. The array
     ...
     *
     * @param prefixOID an array of <code>int</code> values. The array
     *                  is copied. Later changes to <code>prefixOID</code> will therefore not
     *                  affect the OID's value.
     * @param suffixOID an array of <code>int</code> values which will be appended to the
     ...
     *               is copied. Later changes to <code>rawOID</code> will therefore not
     *               affect the OID's value.
     * @param offset the zero based offset into the <code>rawOID</code> that points to the
     *               first sub-identifier of the new OID.
     * @param length the length of the new OID, where <code>offset + length</code> must be
    ...
    private static int[] parseDottedString(String oid) {
        ...
        while (st.hasMoreTokens()) {
            value[size++] = (int) Long.parseLong(st.nextToken());
        }
        return value;
    }
     ...
     *
     * @return the sub-identifies of this <code>OID</code> as a byte array. Each
     ...
     *
     * @param index a zero-based index into the <code>OID</code>.
     ...
     *
     * @param index int
     * @return the sub-indentifier value at <code>index</code> as an unsigned long
     * value.
     */
     ...
     *
     * @param oid an <code>OID</code> instance.
     */
     ...
     *
     * @return <code>true</code> if size() >= 2 and size() <= 128 and if the first
     ...
     * @param other an <code>OID</code> to compare with this <code>OID</code>.
     * @return <UL>
     ...
     *
     * @param n the number of subidentifiers to remove. If <code>n</code> is zero or
     ...
     * @param a an OID.
     * @param b an OID.
     * @return <code>a</code> if a &gt;= b, <code>b</code> otherwise.
     * @since 1.7
     */

...
import cool.mybaby.snmp4j.ff.snmp4j.User;
...
public class UsmUser implements User, Comparable, Cloneable {
     ...
     * @param authenticationProtocol   the authentication protcol ID to be associated with this user. If set
     *                                 to <code>null</code>, this user only supports unauthenticated messages.
     * @param authenticationPassphrase the authentication passphrase. If not <code>null</code>,
     ...
     * @param privacyProtocol          the privacy protcol ID to be associated with this user. If set
     *                                 to <code>null</code>, this user only supports unencrypted messages.
     * @param privacyPassphrase        the privacy passphrase. If not <code>null</code>,
     ...
     *                                 If the length of <code>authenticationPassphrase</code> is less than 8
     *                                 bytes an <code>IllegalArgumentException</code> is thrown.
     * @param localizationEngineID     if not <code>null</code>, the localizationEngineID specifies the
     ...
     *
     * @return a clone of the user's security name.
     */
     ...
     *
     * @return a clone of the authentication protocol ID or <code>null</code>.
     */
     ...
     *
     * @return a clone of the privacy protocol ID or <code>null</code>.
     */
     ...
     *
     * @return a clone of the authentication passphrase or <code>null</code>.
     */
     ...
     *
     * @return a clone of the privacy passphrase or <code>null</code>.
     */
     ...
     * localized.
     *
     * @return <code>null</code> if this USM user is not localized or the SNMP engine
     ...
     *
     * @return <code>true</code> if the passphrases of this USM user represent
     * localized keys.
     * @since 1.6
     */
    ...
    /**
     * Gets the security cool.mybaby.snmp4j.model ID of the USM.
     *
     * @return {@link USM#getID()}
     */
     ...
     *
     * @param o another <code>UsmUser</code> instance.

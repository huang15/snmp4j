...
public class UsmSecurityParameters implements SecurityParameters {
    ...
    public void setUserName(cool.mybaby.snmp4j.ff.snmp4j.smi.OctetString userName) {
        this.userName = userName;
    }

    public cool.mybaby.snmp4j.ff.snmp4j.smi.OctetString getUserName() {
        return userName;
    }
    ...
    public cool.mybaby.snmp4j.ff.snmp4j.smi.OctetString getPrivacyParameters() {
        return privacyParameters;
    }

    public void setPrivacyParameters(cool.mybaby.snmp4j.ff.snmp4j.smi.OctetString privacyParameters) {
        this.privacyParameters = privacyParameters;
    }

    public cool.mybaby.snmp4j.ff.snmp4j.smi.OctetString getAuthenticationParameters() {
        return authenticationParameters;
    }

    public void setAuthenticationParameters(cool.mybaby.snmp4j.ff.snmp4j.smi.OctetString authenticationParameters) {

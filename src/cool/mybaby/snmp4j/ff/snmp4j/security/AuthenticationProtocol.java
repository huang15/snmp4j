...
public interface AuthenticationProtocol extends SecurityProtocol {
     ...
     * value is computed.
     *
     * @param authenticationKey the authentication key to be used for authenticating the message.
     * @param message           the entire message for which the digest should be determined.
     * @param messageOffset     the offset in <code>message</code> where the message actually starts.
     * @param messageLength     the actual message length (may be smaller than
     *                          <code>message.length</code>).
     * @param digest            the offset in <code>message</code> where to store the digest.
     * @return <code>true</code> if the message digest has been successfully computed
     ...
     * @param messageLength     the actual message length (may be smaller than
     *                          <code>message.length</code>).
     * @param digest            the digest of the <code>message</code>.
     * @return <code>true</code> if the message is authentic, <code>false</code>
     * otherwise.
     */
     ...
     *
     * @param oldKey the old authentication/privacy key.
     * @param newKey the new authentication/privacy key.
     * @param random the random 'seed' to be used to produce the digest.
     * @return the byte array representing the delta for key change operations.
     ...
     *
     * @return the number of bytes of digests generated by this authentication
     * procotol.
     */
    int getDigestLength();
}

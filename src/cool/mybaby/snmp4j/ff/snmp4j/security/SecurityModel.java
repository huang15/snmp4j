...
public interface SecurityModel {
    ...
    /**
     * Gets the ID of the security cool.mybaby.snmp4j.model.
     *
     ...
     * security cool.mybaby.snmp4j.model.
     *
     ...
     * this security cool.mybaby.snmp4j.model.
     *
     ...
     *
     * @param messageProcessingModel the ID of the message processing cool.mybaby.snmp4j.model (SNMP version) to use.
     ...
     *                               selected transport mapping (determined by the message processing cool.mybaby.snmp4j.model).
     * @param securityModel          the security cool.mybaby.snmp4j.model for the outgoing message.
     ...
     * @param securityParameters     returns the {@link SecurityParameters} filled by the security cool.mybaby.snmp4j.model.
     ...
     *
     * @param messageProcessingModel   the ID of the message processing cool.mybaby.snmp4j.model (SNMP version) to use.
     * @param maxMessageSize           the maximum message size of the message processing cool.mybaby.snmp4j.model for the
     *                                 transport mapping associated with this message's source address less
     *                                 the length of the maximum header length of the message processing cool.mybaby.snmp4j.model.
     *                                 This value is used by the security cool.mybaby.snmp4j.model to determine the

...
import cool.mybaby.snmp4j.ff.snmp4j.event.UsmUserEvent;
import cool.mybaby.snmp4j.ff.snmp4j.event.UsmUserListener;
import cool.mybaby.snmp4j.ff.snmp4j.log.LogAdapter;
import cool.mybaby.snmp4j.ff.snmp4j.log.LogFactory;
import cool.mybaby.snmp4j.ff.snmp4j.mp.CounterSupport;
import cool.mybaby.snmp4j.ff.snmp4j.mp.MPv3;
import cool.mybaby.snmp4j.ff.snmp4j.mp.SnmpConstants;
import cool.mybaby.snmp4j.ff.snmp4j.mp.StatusInformation;
...
import cool.mybaby.snmp4j.ff.snmp4j.smi.VariableBinding;
...
public class USM implements SecurityModel {
     ...
     *
     * @param securityProtocols the security protocols to support.
     * @param localEngineID     the local engine ID.
     ...
     * @param localEngineID the local engine ID.
     * @param engineBoots   the number of engine boots.
     * @param engineTime    the number sendonds since the last boot.
     */
...
//    return scopedPDU.getBuffer().array();
     ...
     * @param user     the <code>UsmUser</code> to add.
     */
     ...
     *
     * @param userName a user name.
     * @param engineID the authoritative engine ID to be associated with this entry. If
     ...
     *
     * @param entry an <code>UsmUserEntry</code> instance not necessarily the same as an
     ...
     *
     * @param users a possibly empty <code>UsmUser</code> array of users.
     * @since 1.1
     */
     ...
     *
     * @return the <code>UsmUserTable</code> instance containing the users known by
     * this USM.
     */
     ...
     *
     * @param engineID the authoritative engine ID associated with the user, or
     *                 <code>null</code>
     * @param userName a user name.
     * @return the removed <code>UsmUser</code> instance associate with the given
     ...
     * @return the added <code>UsmUserEntry</code>.
     */
     ...
     * message.
     *
     * @return <code>true</code> if discovery is enabled, <code>false</code> otherwise.
     */
     ...
     *
     * @param engineDiscoveryEnabled <code>true</code> if discovery should be enabled,
     ...
     *
     * @param l a proeviously added <code>UsmUserListener</code>.
     */
     ...
     *
     * @param l a <code>UsmUserListener</code> that should be informed about
     ...
     *
     * @param engineID the SNMP engine ID whose engine time to remove.
     * @since 1.6
     */
     ...
     *
     * @param e the <code>UsmUserEvent</code> to fire.
     */
     ...
     *
     * @return a <code>SecurityProtocols</code> instance which is by default the

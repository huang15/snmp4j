...
public class CommunityTarget extends AbstractTarget {
    ...
    private cool.mybaby.snmp4j.ff.snmp4j.smi.OctetString community = new OctetString();
     ...
     * @param community the community to be used for the target.
     */
     ...
     *
     * @param community an <code>OctetString</code> instance which must not be
     *                  <code>null</code>.
     */

...
package cool.mybaby.snmp4j.ff.snmp4j.tools.console;
...
import cool.mybaby.snmp4j.ff.snmp4j.log.JavaLogFactory;
import cool.mybaby.snmp4j.ff.snmp4j.log.LogFactory;
import cool.mybaby.snmp4j.ff.snmp4j.log.LogLevel;
...
import cool.mybaby.snmp4j.ff.snmp4j.transport.AbstractTransportMapping;
import cool.mybaby.snmp4j.ff.snmp4j.transport.DefaultTcpTransportMapping;
import cool.mybaby.snmp4j.ff.snmp4j.transport.DefaultUdpTransportMapping;
import cool.mybaby.snmp4j.ff.snmp4j.util.*;
...
public class SnmpRequest implements CommandResponder, PDUFactory {
    ...
    protected static void printVersion() {
        System.out.println();
        System.out.println("SNMP4J Command Line Tool v1.8.1 Copyright " + (char) 0xA9 +
    ...
    protected static void printReport(PDU response) {
        ...
        if (SnmpConstants.usmStatsUnsupportedSecLevels.equals(oid)) {
            ...
            System.out.print("REPORT: Unknown security cool.mybaby.snmp4j.model.");

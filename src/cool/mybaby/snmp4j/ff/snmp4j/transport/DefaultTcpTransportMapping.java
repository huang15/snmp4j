...
package cool.mybaby.snmp4j.ff.snmp4j.transport;

import cool.mybaby.snmp4j.ff.snmp4j.SNMP4JSettings;
...
import cool.mybaby.snmp4j.ff.snmp4j.smi.TcpAddress;
...
public class DefaultTcpTransportMapping extends TcpTransportMapping {
     ...
     *
     * @param serverAddress the TcpAddress instance that describes the server address to listen
     ...
     * @throws IOException if the remote address cannot be closed due to an IO exception.
     * @since 1.7.1
     */
     ...
     *
     * @param address an <code>TcpAddress</code>. A <code>ClassCastException</code> is thrown
     ...
     *
     * @param serverEnabled if <code>true</code> if the transport will listens for incoming

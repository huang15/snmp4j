...
public abstract class AbstractTarget implements Target {
    ...
    /**
     * Sets the SNMP version (thus the SNMP messagen processing cool.mybaby.snmp4j.model) of the
     * target.
     *
     * @param version the message processing cool.mybaby.snmp4j.model ID.
     * @see cool.mybaby.snmp4j.ff.snmp4j.mp.SnmpConstants#version1
     * @see cool.mybaby.snmp4j.ff.snmp4j.mp.SnmpConstants#version2c
     * @see cool.mybaby.snmp4j.ff.snmp4j.mp.SnmpConstants#version3
     */
    ...
    /**
     * Gets the SNMP version (NMP messagen processing cool.mybaby.snmp4j.model) of the target.
     *
     * @return the message processing cool.mybaby.snmp4j.model ID.
     * @see cool.mybaby.snmp4j.ff.snmp4j.mp.SnmpConstants#version1
     * @see cool.mybaby.snmp4j.ff.snmp4j.mp.SnmpConstants#version2c
     * @see cool.mybaby.snmp4j.ff.snmp4j.mp.SnmpConstants#version3
     */

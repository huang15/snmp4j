...
public class PDUv1 extends PDU {
     ...
     *                                       {@link PDU#V1TRAP}.
     */
    public void setEnterprise(cool.mybaby.snmp4j.ff.snmp4j.smi.OID enterprise) {
        checkV1TRAP();
     ...
     *                                       {@link PDU#V1TRAP}.
     */
    public cool.mybaby.snmp4j.ff.snmp4j.smi.IpAddress getAgentAddress() {
        checkV1TRAP();
        return agentAddress;
    }
     ...
     *
     * @param agentAddress a <code>IpAddress</code> instance.
     * @throws UnsupportedOperationException if the type of this PDU is not
     *                                       {@link PDU#V1TRAP}.
     */
    public void setAgentAddress(cool.mybaby.snmp4j.ff.snmp4j.smi.IpAddress agentAddress) {
        checkV1TRAP();
     ...
     * specific trap.
     *
     * @param genericTrap an integer value >= 0 and <= 6.
     * @throws UnsupportedOperationException if the type of this PDU is not
     *                                       {@link PDU#V1TRAP}.
     */
     ...
     *
     * @param specificTrap an integer value > 0.
     * @throws UnsupportedOperationException if the type of this PDU is not
     *                                       {@link PDU#V1TRAP}.
     */
     ...
     *
     * @param parameter an Object instance.

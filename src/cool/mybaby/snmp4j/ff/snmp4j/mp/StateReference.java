...
import cool.mybaby.snmp4j.ff.snmp4j.security.SecurityStateReference;
 ...
 * (SNMPv3 only). Depending on the security cool.mybaby.snmp4j.model not all fields may be filled.
 *
 * @author Frank Fock
 * @version 1.2
 */
public class StateReference implements Serializable {
    ...
    public void setAddress(cool.mybaby.snmp4j.ff.snmp4j.smi.Address address) {

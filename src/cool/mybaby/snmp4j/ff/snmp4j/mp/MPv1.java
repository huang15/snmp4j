...
/**
 * The <code>MPv1</code> is the message processing cool.mybaby.snmp4j.model for SNMPv1.
 *
 * @author Frank Fock
 * @version 1.0
 */
public class MPv1 implements MessageProcessingModel {
    ...
    public int prepareOutgoingMessage(Address transportAddress,
        ...
        if ((securityLevel != SecurityLevel.NOAUTH_NOPRIV) ||
            ...
            logger.error("MPv1 used with unsupported security cool.mybaby.snmp4j.model");

...
public class StatusInformation implements Serializable {
    ...
    public void setSecurityLevel(cool.mybaby.snmp4j.ff.snmp4j.smi.Integer32 securityLevel) {
        this.securityLevel = securityLevel;
    }

    public cool.mybaby.snmp4j.ff.snmp4j.smi.Integer32 getSecurityLevel() {

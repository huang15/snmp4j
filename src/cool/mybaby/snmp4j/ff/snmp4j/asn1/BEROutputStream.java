...
public class BEROutputStream extends OutputStream {
     ...
     * as backing buffer.
     *
     * @param buffer a <code>ByteBuffer</code> whose limit and capacity must be greater or
     ...
     * byte array!
     *
     * @return the ByteBuffer backing this output stream with its current position
     ...
     *
     * @return the <code>ByteBuffer</code> backing this output stream.
     */

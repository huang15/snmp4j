...
package cool.mybaby.snmp4j.ff.snmp4j.asn1;
...
public class BER {
     ...
     * @param os     an <code>OutputStream</code> to which the length is encoded.
     * @param type   the tag type for the integer (typically 0x02)
     * @param string the <code>byte</code> array containing the octet string value.
     * @throws IOException
     */
     ...
     * @param oid  the <code>int</code> array containing the OID value.
     * @throws IOException
     */
     ...
     *
     * @param is          an <code>InputStream</code>
     * @param checkLength if <code>false</code> length check is always suppressed.
     * @return the decoded length.
     * @throws IOException
     */
     ...
     *
     * @return <code>true</code> if the length of a parsed SEQUENCE should be checked

...
public interface MessageDispatcher extends TransportListener {
     ...
     * a message processing cool.mybaby.snmp4j.model to process messages before they can be
     * dispatched.
     *
     ...
     *                               be saved (if needed for the supplied message processing cool.mybaby.snmp4j.model).
     ...
     * <code>PduHandle</code> in the specified message processing cool.mybaby.snmp4j.model.
     *
     * @param messageProcessingModel a message processing cool.mybaby.snmp4j.model ID.

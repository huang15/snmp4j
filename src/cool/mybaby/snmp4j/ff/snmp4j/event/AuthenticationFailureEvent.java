...
public class AuthenticationFailureEvent extends EventObject {
     ...
     * @param sourceAddress the address from where the failed message has been received.
     * @param transport     the <code>TransportMapping</code> with which the message has been
     *                      received.
     * @param error         the SNMP4J MP error status caused by the message
     *                      (see {@link SnmpConstants}).
     * @param message       the message as received at the position where processing the message
     *                      has stopped.
     */
    public AuthenticationFailureEvent(Object source,
     ...
     *
     * @return a <code>BERInputStream</code> at the position where processing of the
     * message has stopped.
     */
     ...
     *
     * @return the source <code>Address</code>.
     */

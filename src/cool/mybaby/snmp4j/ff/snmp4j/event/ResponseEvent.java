...
package cool.mybaby.snmp4j.ff.snmp4j.event;

import cool.mybaby.snmp4j.ff.snmp4j.PDU;
import cool.mybaby.snmp4j.ff.snmp4j.Session;
...
public class ResponseEvent extends EventObject {
     ...
     * @param peerAddress the transport address of the entity that send the response.
     * @param request     the request PDU (must not be <code>null</code>).
     * @param response    the response PDU or <code>null</code> if the request timed out.
     ...
     * @param response    the response PDU or <code>null</code> if the request timed out.
     * @param userObject  an optional user object.
     * @param error       an <code>Exception</code>.
     */
     ...
     *
     * @return a PDU instance if a response has been received. If the request
     ...
     * {@link Session#send(PDU pdu, Target target, Object userHandle,
     ...
     *
     * @return the transport <code>Address</code> of the command responder that send

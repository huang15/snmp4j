...
import cool.mybaby.snmp4j.ff.snmp4j.smi.Counter32;
import cool.mybaby.snmp4j.ff.snmp4j.smi.Counter64;
import cool.mybaby.snmp4j.ff.snmp4j.smi.OID;
import cool.mybaby.snmp4j.ff.snmp4j.smi.Variable;
...
public class CounterEvent extends EventObject {
     ...
     * @param oid    the OID of the counter instance (typically, the counter is a scalar and
     ...
     *
     * @return a {@link Counter32} or {@link Counter64} instance.
     */
     ...
     *
     * @param currentValue a {@link Counter32} or {@link Counter64} instance.
     */

...
import cool.mybaby.snmp4j.ff.snmp4j.transport.TransportListener;
...
public interface TransportMapping {
     ...
     *
     * @param dispatcher a MessageDispatcher instance.
     * @see MessageDispatcherImpl
     * @deprecated Use {@link #addTransportListener} instead. This method has
     ...
     *
     * @param dispatcher a previously added MessageDispatcher instance.
     * @see #addMessageDispatcher
     * @deprecated Use {@link #removeTransportListener} instead.
     */

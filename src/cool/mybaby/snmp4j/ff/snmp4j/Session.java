...
public interface Session {
     ...
     * be used.
     *
     * @throws IOException if the session could not free all resources.
     */
     ...
     *
     * @param pdu    the <code>PDU</code> to send.
     * @param target the <code>Target</code> instance that specifies how and where to send
     *               the PDU.
     ...
     *
     * @param request  a request PDU as sent via {@link #send(PDU pdu, Target target,
     *                 Object userHandle, ResponseListener listener)} or any .
     * @param listener a ResponseListener instance.
     */

...
public class UserTarget extends SecureTarget {
    ...
    /**
     * Creates a target for a user based security cool.mybaby.snmp4j.model target.
     */
    public UserTarget() {
    }
    ...
    /**
     * Gets the security cool.mybaby.snmp4j.model for the user target.
     *
    ...
    /**
     * Sets the security cool.mybaby.snmp4j.model for the user target.
     *

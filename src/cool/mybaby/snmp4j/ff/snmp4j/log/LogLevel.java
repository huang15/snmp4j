...
public class LogLevel {
    ...
    private static final String[] LEVEL_STRINGS = {
            "NONE", "OFF", "ALL", "TRACE", "DEBUG", "INFO", "WARN", "INFO", "ERROR", "FATAL"
    };
     ...
     *
     * @param levelString one of the level strings "OFF", "ALL", "TRACE", "DEBUG", "INFO", "WARN",
     *                    "INFO", "ERROR", and "FATAL".
     * @return a number > 0 if the level string could be converted into a level,
     * 0 otherwise.
     */
     ...
     * @param levelString one of the level strings "OFF", "ALL", "TRACE", "DEBUG", "INFO", "WARN",
     *                    "INFO", "ERROR", and "FATAL".
     * @return one of the <code>LogLevel</code> constants defined by this class.
     * @since 1.7.2
     */

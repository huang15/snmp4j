...
import cool.mybaby.snmp4j.ff.snmp4j.mp.PduHandle;
import cool.mybaby.snmp4j.ff.snmp4j.mp.StateReference;
...
public class CommandResponderEvent extends EventObject {
     ...
     * @param messageProcessingModel   the message processing cool.mybaby.snmp4j.model ID.
     * @param securityModel            the security cool.mybaby.snmp4j.model ID.
    ...
    /**
     * Gets the security cool.mybaby.snmp4j.model used by the command.
     *
     * @return int
     */
    ...
    public void setPduHandle(cool.mybaby.snmp4j.ff.snmp4j.mp.PduHandle pduHandle) {
    ...
    public void setStateReference(cool.mybaby.snmp4j.ff.snmp4j.mp.StateReference stateReference) {
        this.stateReference = stateReference;
    }

    public cool.mybaby.snmp4j.ff.snmp4j.mp.StateReference getStateReference() {

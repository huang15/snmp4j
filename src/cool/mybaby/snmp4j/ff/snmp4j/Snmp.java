...
package cool.mybaby.snmp4j.ff.snmp4j;

import cool.mybaby.snmp4j.ff.snmp4j.event.ResponseEvent;
import cool.mybaby.snmp4j.ff.snmp4j.event.ResponseListener;
import cool.mybaby.snmp4j.ff.snmp4j.log.LogAdapter;
import cool.mybaby.snmp4j.ff.snmp4j.log.LogFactory;
import cool.mybaby.snmp4j.ff.snmp4j.mp.*;
import cool.mybaby.snmp4j.ff.snmp4j.security.*;
import cool.mybaby.snmp4j.ff.snmp4j.smi.*;
import cool.mybaby.snmp4j.ff.snmp4j.transport.ConnectionOrientedTransportMapping;
import cool.mybaby.snmp4j.ff.snmp4j.transport.TransportMappings;
...
public class Snmp implements Session, CommandResponder {
     ...
     *
     * @param messageDispatcher a <code>MessageDispatcher</code> instance that will be used to
     *                          dispatch incoming and outgoing messages.
     * @param transportMapping  the initial <code>TransportMapping</code>,
     ...
     *
     * @param transportMapping a <code>TransportMapping</code> instance.
     */
     ...
     *
     * @param transportMapping a previously added <code>TransportMapping</code>.
     */
     ...
     *
     * @param listenAddress the <code>Address</code> denoting the transport end-point
     *                      (interface and port) to listen for incoming notifications.
     * @param listener      the <code>CommandResponder</code> instance that should handle
     ...
     * endpoint.
     *
     * @param listenAddress the listen <code>Address</code> to be removed.
     ...
     *
     * @throws IOException if a transport mapping throws an <code>IOException</code> when its
     ...
     * target.
     *
     * @param pdu    a <code>PDU</code> instance. For SNMPv3 messages, the supplied PDU
     *               instance has to be a <code>ScopedPDU</code> instance.
     * @param target the Target instance representing the target SNMP engine where to send
     *               the <code>pdu</code>.
     ...
     * @throws IOException if the PDU cannot be sent to the target.
     * @since 1.1
     */
     ...
     *
     * @param pdu        the PDU instance to send.
     * @param target     the Target instance representing the target SNMP engine where to send
     *                   the <code>pdu</code>.
     * @param userHandle an user defined handle that is returned when the request is returned
     *                   via the <code>listener</code> object.
     * @param listener   a <code>ResponseListener</code> instance that is called when
     ...
     * {@link ResponseEvent#getResponse()}. If the request timed out,
     * that method will return <code>null</code>.
     * @throws IOException if the inform request could not be send to the specified target.
     * @since 1.1
     */
     ...
     * synchronously.
     *
     * @param pdu       a <code>PDU</code> instance. When sending a SNMPv1 trap PDU, the
     ...
     * @param target    the Target instance representing the target SNMP engine where to send
     *                  the <code>pdu</code>.
     * @param transport specifies the <code>TransportMapping</code> to be used when sending
     ...
     * @param target the Target instance representing the target SNMP engine where to send
     *               the <code>pdu</code>.
     * @return the received response <code>PDU</code> or <code>null</code>
     ...
     *                   <code>pdu</code> is a confirmed PDU and the request is either answered
     *                   or timed out.
     * @throws IOException if the PDU could not be sent to the specified target.
     ...
     *
     * @param pdu               the <code>PDU</code> instance to be sent.
     * @param target            a <code>Target</code> instance denoting the target SNMP entity.
     * @param transport         the (optional) transport mapping to be used to send the request.
     *                          If <code>transport</code> is <code>null</code> a suitable transport
     *                          mapping is determined from the <code>target</code> address.
     * @param pduHandleCallback callback for newly created PDU handles before the request is sent out.
     * @return PduHandle
     * that uniquely identifies the sent PDU for further reference.
     * @throws IOException if the transport fails to send the PDU or the if the message cannot
     *                     be BER encoded.
     */
     ...
     * <code>USM</code>.
     *
     * @param engineID    a byte array containing the local engine ID. The length and content
     *                    has to comply with the constraints defined in the SNMP-FRAMEWORK-MIB.
     * @param engineBoots the number of boots of this SNMP engine (zero based).
     * @param engineTime  the number of seconds since the value of engineBoots last changed.
     * @see MPv3
     * @see USM
     */
     ...
     * </em>
     *
     * @param address an Address instance representing the transport address of the SNMPv3
     ...
     *
     * @return an <code>USM</code> instance if available in the current SNMP4J
    ...
    /**
     * Gets the message processing cool.mybaby.snmp4j.model for the supplied ID.
     *
     * @param messageProcessingModel a mesage processing cool.mybaby.snmp4j.model ID as defined in {@link MessageProcessingModel}.
     ...
     *
     * @param event a <code>CommandResponderEvent</code> with the decoded incoming PDU as
     ...
     *
     * @param listener a previously added <code>CommandResponder</code> instance.
     */
     ...
     * session.
     *
     * @param listener the <code>CommandResponder</code> instance to be added.
     */
     ...
     *
     * @param event a <code>CommandResponderEvent</code>.
     */
    ...
    /**
     * Gets the timeout cool.mybaby.snmp4j.model associated with this SNMP session.
     *
    ...
    /**
     * Sets the timeout cool.mybaby.snmp4j.model for this SNMP session. The default timeout cool.mybaby.snmp4j.model
     ...
     * the request. By specifying a different timeout cool.mybaby.snmp4j.model this behaviour can
     * be changed.
     *
     * @param timeoutModel a <code>TimeoutModel</code> instance (must not be <code>null</code>).
     */
    public void setTimeoutModel(TimeoutModel timeoutModel) {
        if (timeoutModel == null) {
            throw new NullPointerException("Timeout cool.mybaby.snmp4j.model cannot be null");
        }
     ...
     *
     * @param reportHandler a <code>ReportHandler</code> instance which must not be
     *                      <code>null</code>.
     * @since 1.6
     */
    ...
    class NotificationDispatcher implements CommandResponder {
         ...
         *
         * @param event the <code>CommandResponderEvent</code> with the INFORM request.
         * @throws MessageException if the response could not be created and sent.
         */

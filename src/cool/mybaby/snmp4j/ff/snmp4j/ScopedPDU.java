...
public class ScopedPDU extends PDU {
     ...
     * Copy constructor.
     *
     * @param other a <code>ScopedPDU</code> instance.
     */
     ...
     *
     * @param contextEngineID an <code>OctetString</code> instance (must not be <code>null</code>).
     ...
     *
     * @return an <code>OctetString</code> instance.
     */
     ...
     *
     * @param contextName an <code>OctetString</code> instance (must not be <code>null</code>).
     */
